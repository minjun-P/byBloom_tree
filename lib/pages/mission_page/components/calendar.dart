        ...
        children: [
          ...
          ValueListenableBuilder<List<Event>>(
              ...
              builder: (context, value, _){
                final int num = value.length;
                List trueList = value.where((event) => event.complete ==true).toList();

                while(value.length < 4){
                  value.add(Event('',false));
                }
                return Container(
                  padding: EdgeInsets.symmetric(vertical: 20,horizontal: 30),
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    children: [
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text('${_selectedDay!.day}',style: TextStyle(fontSize: 25),),
                          Text('${getWeekDay(_selectedDay!.weekday)}',style: TextStyle(fontSize: 20,color: Colors.blueGrey),),
                          SizedBox(width: 15,),
                          Text('달성목표 ${trueList.length} |',style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold),),
                          SizedBox(width: 5,),
                          Text('미달성 목표 ${num-trueList.length}',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold),)
                        ],
                      ),
                      SizedBox(height: 10,),
                      Table(
                              ...
                              children: [
                                TableCell(
                                  ...
                                  Container(
                                      ...
                                      child: Text('${value[0].title}',style: TextStyle(color: value[0].complete?Colors.green:Colors.grey,fontWeight: FontWeight.bold),)
                                  ),
                                ),
                                TableCell(
                                  child:
                                  Container(
                                      ...
                                      height: 40,
                                      alignment: Alignment.center,
                                      child: Text('${value[1].title}',style: TextStyle(color: value[1].complete?Colors.green:Colors.grey,fontWeight: FontWeight.bold),)
                                  ),
                                ),
                              ]
                          ),
                              ...
                              children: [
                                TableCell(
                                  ...
                                  Container(
                                      ...
                                      height: 40,
                                      alignment: Alignment.center,
                                      child: Text('${value[2].title}',style: TextStyle(color: value[2].complete?Colors.green:Colors.grey,fontWeight: FontWeight.bold),)
                                  ),
                                ),
                                TableCell(
                                  child:
                                  Container(
                                      ...
                                      height: 40,
                                      alignment: Alignment.center,
                                      child: Text('${value[3].title}', style: TextStyle(color: value[3].complete?Colors.green:Colors.grey, fontWeight: FontWeight.bold),)
                                  ),
                                ),
                              ]
                          )
